<template>
  <div class="max-w-[473px] mx-auto py-[100px]">
    ...
    <div class="mt-[20px]">
      ...
      <div class="flex gap-4 mt-[20px]">
        <div class="flex-1 basis-1/2">
          <input type="radio" id="gender-male" value="male" v-model="gender" name="gender" class="sr-only peer" />
        ...
        <!-- Female -->
        <div class="flex-1 basis-1/2">
          <input type="radio" id="gender-female" value="female" v-model="gender" name="gender" class="sr-only peer" />
    ...
    <UButton label="Continue" @click="completeProfile"
